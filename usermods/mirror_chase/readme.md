...
1. Copy the `usermod_mirror_chase.h` file to `usermods/mirror_chase/`
2. Add `#define USERMOD_MIRROR_CHASE` to your `platformio_override.ini` or build flags
3. Compile and flash WLED
...
Or add to existing build_flags section.
